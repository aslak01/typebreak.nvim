...
M.repr = function(time)
	local last = #M.previous_times > 0 and M.previous_times[#M.previous_times] or "N/A"
	local avg = #M.previous_times > 0
			and string.format("%.2f", ((time + utils.table_sum(M.previous_times)) / (#M.previous_times + 1)))
		or "N/A"
